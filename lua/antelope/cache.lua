...
local cache_filename = 'antelope_cache'
...
function module.setup()
  vim.api.nvim_command('autocmd DirChanged * lua require("antelope.cache").load()')
  vim.api.nvim_command('autocmd VimLeavePre * lua require("antelope.cache").persist()')
  module.load()
end
