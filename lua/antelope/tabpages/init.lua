local icons = require('antelope.icons')
local util = require('antelope.util')

local notify = require('antelope.helpers').notify
...
module.options = require('antelope.tabpages.options')

local state_to_handle_hl = setmetatable({
  ['DELETING'] = 'AntelopeHandleDelete',
}, {
  __index = function()
    return 'AntelopeHandleTabpage'
  end,
})
